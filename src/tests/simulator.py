...
async def main():
    async with Simulator() as sim:
        ...
        # Add a delay to allow iSponsorBlockTV to fully initialize
        print("Waiting for iSponsorBlockTV to initialize...")
        await asyncio.sleep(10)  # 10 second delay, adjust if needed
